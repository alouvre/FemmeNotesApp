              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  onChanged: (String? newValue) {
                    setState(() {
                      selectedRemind = newValue ?? selectedRemind;
                    });
                  },
                  items: remindOptions.map((String value) {
                    return DropdownMenuItem<String>(
                      ...
                      child: Text(
                        ...
                        style: primaryTextStyle.copyWith(
                          fontSize: 16,
                          fontWeight: regular,
                          color: value == "Choose remind time"
                              ? subtitleColor01
                              : primaryColor,
                        ),
                      ),
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  onChanged: (String? newValue) {
                    setState(() {
                      selectedRepeat = newValue ?? selectedRepeat;
                    });
                  },
                  items: remindOptions.map((String value) {
                    return DropdownMenuItem<String>(
                      ...
                      child: Text(
                        ...
                        style: primaryTextStyle.copyWith(
                          ...
                          fontWeight: regular,
                          color:
                              value == "None" ? subtitleColor01 : primaryColor,
                        ),
                      ),
                    );
                  }).toList(),
